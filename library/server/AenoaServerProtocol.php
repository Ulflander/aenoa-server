...
/**
 * <p>AenoaServerProtocol is the protocol used to access to Aenoa services.</p>
 * 
 * <p>This protocol is based on a service identifier and an array of data encoded in json.</p>
 * 
 * <p>AenoaServerProtocol works only with POST data, with a 
 * <pre>application/x-www-form-urlencoded</pre> content type.</p>
 * 
 * <h3>Parameters</h3>
 * 
 * <p>Two parameters are required:</p>
 * <ul>
 * <li><pre>service</pre>: The service identifier, formatted as <pre>package.service.method</pre></li>
 * <li><pre>data</pre>: The data given to the service, encoded in JSON</li>
 * </ul>
 * 
 * <h3>Returns</h3>
 * <p>Aenoa services returns an object encoded in JSON containing the following properties:</p>
 * <ul>
 * <li></li>
 * </ul>
 * 
 ...
 * 
 * <h3>Examples</h3>
 * <p>We assume a service named "test" in package "pack" with a method named "testMethod".</p>
 * 
 * <h4>Using services from PHP</h4>
 * <p>For PHP we can use the curl methods:</p>
 * <pre></pre>
 * 
 * <h4>Using services from JavaScript with AJSF</h4>
 * 
 * 
 * 
 * @see Gateway
